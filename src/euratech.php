            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="../src/Images/euratech/slidereura1.jpg" alt="First slide">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../src/Images/euratech/slidereura2.png" alt="Second slide">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus porta est a nunc fermentum imperdiet. Morbi in
                            ex sed neque convallis accumsan id nec ante. Donec condimentum neque justo, et facilisis justo pharetra eu.
                        </p>
                    </div>
        ...
        <div class="row justify-content-between pb-4">
            <div class="col-md-4">
                <div class="card events">
                    <img class="card-img-top event" id="event" src="../src/Images/euratech/veetevent.png" alt="Card image cap">
                    <img class="card-img-top event" id="eventhidden" src="../src/Images/euratech/veeteventover.png" alt="Card image cap">
                    <div class="card-body">
