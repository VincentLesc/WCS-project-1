...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav w-100 justify-content-end">
                    <a class="nav-item nav-link mr-5" href="#index">Home<span class="sr-only">(current)</span></a>
                    <a class="nav-item nav-link mr-5" href="#instructors">Instructors</a>
                    <a class="nav-item nav-link mr-5" href="#wilders">Wilders</a>
        ...
        <section>
            ...
            <h1 class="mt-3 mb-4 text-center" id="wilders">Wilders</h1>
            <img src="https://via.placeholder.com/350x200" alt="Img" class="img-fluid float-lg-right ml-lg-3 ml-2 mr-3 mb-3">
        ...
        <section>
            <div class="container-fluid">
                <div class="row justify-content-between ml-lg-1 ml-5">
                    <img src="https://via.placeholder.com/150x150" alt="Img" class="img-fluid rounded-circle ml-lg-3 ml-2 mr-3 mb-3">
                    <img src="https://via.placeholder.com/150x150" alt="Img" class="img-fluid rounded-circle ml-lg-3 ml-2 mr-3 mb-3">
                    <img src="https://via.placeholder.com/150x150" alt="Img" class="img-fluid rounded-circle ml-lg-3 ml-2 mr-3 mb-3">
                    <img src="https://via.placeholder.com/150x150" alt="Img" class="img-fluid rounded-circle ml-lg-3 ml-2 mr-3 mb-3">
                    <img src="https://via.placeholder.com/150x150" alt="Img" class="img-fluid rounded-circle ml-lg-3 ml-2 mr-3 mb-3">
                ...
                <div class="row">
                    <p class="ml-3 mr-3 text-justify">
                        ...
                        enim est eleifend mi, non fermentum diam nisl sit amet erat. Duis semper. 
                        Duis arcu massa, scelerisque vitae, consequat in, pretium a, enim. Pellentesque congue. 
                        Ut in risus volutpat libero pharetra tempor. Cras vestibulum bibendum augue.                        Proin porttitor, orci nec nonummy molestie,
                        enim est eleifend mi, non fermentum diam nisl sit amet erat. Duis semper. 
                        Duis arcu massa, scelerisque vitae, consequat in, pretium a, enim. Pellentesque congue. 
                        Ut in risus volutpat libero pharetra tempor. Cras vestibulum bibendum augue.
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, 
        ...
        <section>
            <h3 class="text-center mt-4 mb-4">Quiz Wilders</h3>
            <div class="container mb-3">
                <div class="row justify-content-between">
                    <div class="card mb-3 p-3 ml-lg-1 ml-4">
                        <div class="card-body text-center ml-lg-1 ml-3">
                          Question 1
                        </div>
                ...
                <div class="card mt-3 mb-3 p-2 ml-lg-1 ml-3 bg-dark ">
                    <div class="card-body text-center ml-lg-1 ml-3 text-white">
                        RESULTS
                    </div>
                </div>
            </div>
