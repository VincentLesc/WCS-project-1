...
<body>
    <header>
        ...
        <section>
            ...
            <div class="container mt-5 ml-4 ml-lg-auto">
            ...
            <div class="container mt-5 mb-5 mt-5 ml-4 ml-lg-auto">
                <div class="row justify-content-between">
                    <img class="card-img-top mb-3" src="https://via.placeholder.com/150x150" alt="Funny image" style="width: 18rem;">
                    <img class="card-img-top mb-3" src="https://via.placeholder.com/150x150" alt="Funny image" style="width: 18rem;">
                    <img class="card-img-top mb-3" src="https://via.placeholder.com/150x150" alt="Funny image" style="width: 18rem;">
                </div>
            </div>
